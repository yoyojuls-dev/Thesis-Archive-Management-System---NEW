...
interface VpaaLoginFormProps {
  currentUser: SafeUser | null;
}

const VpaaLoginForm: React.FC<VpaaLoginFormProps> = ({ currentUser }) => {
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl">
        ...
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Vice President for Academic Affairs Portal
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/vpaa/register" className="font-medium text-red-600 hover:text-red-500">
                Register
              </Link>
            </p>
